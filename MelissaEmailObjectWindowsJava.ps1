# Name:    MelissaEmailObjectWindowsJava
# Purpose: Use the Melissa Updater to make the MelissaEmailObjectWindowsJava code usable
...
javac -cp mdEmail.jar MelissaEmailObjectWindowsJava.java
jar cvfm MelissaEmailObjectWindowsJava.jar manifest.txt *.class *.dll mdEmail.jar
